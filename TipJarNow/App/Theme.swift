...
extension Color {
    ...
    static let brandPrimary   = Color(red: 0.06, green: 0.73, blue: 0.51)
    static let brandSecondary = Color(red: 0.02, green: 0.47, blue: 0.34)
    static let brandTint      = Color(red: 0.32, green: 0.85, blue: 0.65)
